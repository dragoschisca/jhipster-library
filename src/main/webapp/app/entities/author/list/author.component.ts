...
import { AuthorService, EntityArrayResponseType } from '../service/author.service';
...
export class AuthorComponent implements OnInit {
  ...
  trackId = (item: IAuthor): number => this.authorService.getAuthorIdentifier(item);
