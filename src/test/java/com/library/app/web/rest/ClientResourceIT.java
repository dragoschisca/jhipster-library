...
import static com.library.app.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).address(UPDATED_ADDRESS);
